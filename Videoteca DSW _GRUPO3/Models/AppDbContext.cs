...
namespace Videoteca_DSW__GRUPO3.Models
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<Actividad> Actividades { get; set; } // Refleja la tabla dbo.Administrador
        public DbSet<Equipo> Equipos { get; set; } // Refleja la tabla dbo.Administrador
        public DbSet<Inventario> Inventarios { get; set; } // Refleja la tabla dbo.Administrador
        public DbSet<Prestamo> Prestamos { get; set; } // Refleja la tabla dbo.Administrador
    }
}
